...
class poseDetector():
    def __init__(self, mode=False, upBody=False,smooth=True,detectionCon=0.5,trackCon=0.5):
        self.mode=mode
        self.upBody=upBody# not used anymore in this 
        self.smooth=smooth
    ...
    def findAngle(self,img,p1,p2,p3,draw=True):
        # get the landmarks
        x1,y1=self.lmList[p1][1:]    # or _,x1,y1=self.lmlist[p1]
...
def main():
    cap = cv2.VideoCapture(r"G:\MY PROJECTS\OPENCV PROJECTS\ADVANCED\Pose Estimation\PoseVideos\4.mp4")
    pTIme=0
